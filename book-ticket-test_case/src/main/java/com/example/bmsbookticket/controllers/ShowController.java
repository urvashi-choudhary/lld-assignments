...
public class ShowController {
	...
	public CreateShowResponseDTO createShow(CreateShowRequestDTO requestDTO) {
		...
		try {
			Show show = showService.createShow(requestDTO.getUserId(), requestDTO.getMovieId(),
					requestDTO.getScreenId(), requestDTO.getStartTime(), requestDTO.getEndTime(),
					requestDTO.getPricingConfig(), requestDTO.getFeatures());
