...
public class OrderServiceImpl implements OrderService {
	...
	public Order placeOrder(int userId, int addressId, List<Pair<Integer, Integer>> orderDetails)
		...
		Address address = addressRepository.findById(addressId)
				.orElseThrow(() -> new InvalidAddressException("Address doesn't exist"));
		...
		// Check if any of the product is a high demand product, if yes check is
		// quantity is within limit
		List<HighDemandProduct> highDemandProductIds = highDemandProductRepository
				.findAllByProductIdIn(productQuantityMap.keySet().stream().toList());
